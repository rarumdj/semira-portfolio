  ...
  return (
    <section id="home" className="header-bg ">
      <div className="pt-20 lg:pb-28 container mx-auto flex flex-col items-center px-6 lg:px-16 w-screen max-w-[100rem]">
        <div className="h-full relative md:pr-44 pr-0 w-full md:mt-48 mt-20 space-y-10">
        ...
        transition={{
          ...
          easings: ["easeIn", "easeOut"],
            ...
            <ul className="md:text-[18px] text-sm text-[#c4c4c4] list-disc list-inside ml-4 leading-loose font-light">
              <li>
