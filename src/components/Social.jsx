  ...
  return (
    <div className="md:py-24 py-20 flex justify-center">
      ...
      <div className="flex items-center w-full mb-10">
        <h1 className="custom-font md:text-[24px] md:w-fit w-8/12 md:mr-4 text-white">SAY HI TO ME AT MY LITTLE CORNERS ONLINE </h1><span><Hello className="md:p-0 p-1"/></span>
      </div>
